...
proposal: what my imagination leaps to _exists_. “Light rays” _do not
exist_. Therefore arguments appealing to them, either explicitly or
implicitly, are pure nonsense.] The script assumes you have a TeX
installation. A good way to generate the GIF is
