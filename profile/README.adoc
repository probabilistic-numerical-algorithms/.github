...
image::https://github.com/probabilistic-numerical-algorithms/.github/blob/master/profile/master_field_equation.png[The basis vectors of Cl(4,1,1) and the Master Field Equation]
