...
Here is an aid in visualizing how radio and light waves travel and
thus why there is a unified field theory in which it becomes easy to
re-analyze “quantum” computers and redo the algorithms digitally:
